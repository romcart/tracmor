 ...
 */
	...
	class AssetModelListForm extends AssetModelListFormBase {
      ...
      $this->dtgAssetModel->AddColumn(new QDataGridColumnExt('Asset Model Code', '<?= (QString::Truncate($_ITEM->AssetModelCode, 200)); ?>', 'FontBold=true', 'SortByCommand="asset_model_code ASC"', 'ReverseSortByCommand="asset_model_code DESC"', 'CssClass="dtg_column"'));
