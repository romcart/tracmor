<?php
	...
	class ReceiptCustomFieldHelperGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new ReceiptCustomFieldHelper object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return ReceiptCustomFieldHelper::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
