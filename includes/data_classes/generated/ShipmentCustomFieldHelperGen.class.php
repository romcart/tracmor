<?php
	...
	class ShipmentCustomFieldHelperGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new ShipmentCustomFieldHelper object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return ShipmentCustomFieldHelper::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
