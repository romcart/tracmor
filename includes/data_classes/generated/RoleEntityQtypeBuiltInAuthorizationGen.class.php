<?php
	 ...
	 * @property integer $RoleEntityBuiltInId the value for intRoleEntityBuiltInId (Read-Only PK)
	...
	class RoleEntityQtypeBuiltInAuthorizationGen extends QBaseClass {
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder->AddFromItem('role_entity_qtype_built_in_authorization');
		...
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return RoleEntityQtypeBuiltInAuthorization::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		}
		...
		*/
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null, $strColumnAliasArray = null) {
			...
			if ($strExpandAsArrayNodes) {
				$objLastRowItem = null;
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = RoleEntityQtypeBuiltInAuthorization::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = RoleEntityQtypeBuiltInAuthorization::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
				...
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strModifiedDate)
							throw new QOptimisticLockingException('RoleEntityQtypeBuiltInAuthorization');
					}
