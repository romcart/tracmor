<?php
	...
	class VersionGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Instantiate a new Version object and return it
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
		...
		*/
		...
		/**
		 * Instantiate a single Version object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return Version next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return Version::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, null, $strColumnAliasArray);
		}
		 ...
		 * @return Version
		*/
		public static function LoadByVersion($strVersion, $objOptionalClauses = null) {
			return Version::QuerySingle(
				QQ::Equal(QQN::Version()->Version, $strVersion)
			, $objOptionalClauses
			);
		...
		public function Journal($strJournalCommand) {
			$objDatabase = Version::GetDatabase()->JournalingDatabase;
		 ...
		 * @param integer strVersion
		 * @return Version[]
		 */
		public static function GetJournalForId($strVersion) {
			$objDatabase = Version::GetDatabase()->JournalingDatabase;

			$objResult = $objDatabase->Query('SELECT * FROM _version WHERE version = ' .
				$objDatabase->SqlVariable($strVersion) . ' ORDER BY __sys_date');

			return Version::InstantiateDbResult($objResult);
		}
		...
		public function GetJournal() {
			return Version::GetJournalForId($this->strVersion);
		}
