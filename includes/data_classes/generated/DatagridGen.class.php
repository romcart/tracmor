<?php
	 ...
	 * @property integer $DatagridId the value for intDatagridId (Read-Only PK)
	 * @property string $ShortDescription the value for strShortDescription (Unique)
	 * @property DatagridColumnPreference $_DatagridColumnPreference the value for the private _objDatagridColumnPreference (Read-Only) if set due to an expansion on the datagrid_column_preference.datagrid_id reverse relationship
	 * @property DatagridColumnPreference[] $_DatagridColumnPreferenceArray the value for the private _objDatagridColumnPreferenceArray (Read-Only) if set due to an ExpandAsArray on the datagrid_column_preference.datagrid_id reverse relationship
	...
	class DatagridGen extends QBaseClass {
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder->AddFromItem('datagrid');
		...
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return Datagrid::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		}
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null, $strColumnAliasArray = array()) {
			...
			if (($strExpandAsArrayNodes) && ($objPreviousItem) &&
				($objPreviousItem->intDatagridId == $objDbRow->GetColumn($strAliasName, 'Integer'))) {
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null, $strColumnAliasArray = null) {
			...
			if ($strExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Datagrid::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = Datagrid::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
