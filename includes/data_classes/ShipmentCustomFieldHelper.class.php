	...
	/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			...
			return ShipmentCustomFieldHelper::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::ShipmentCustomFieldHelper()->Param1, $strParam1),
					QQ::GreaterThan(QQN::ShipmentCustomFieldHelper()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single ShipmentCustomFieldHelper object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of ShipmentCustomFieldHelper objects
			return ShipmentCustomFieldHelper::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::ShipmentCustomFieldHelper()->Param1, $strParam1),
					QQ::Equal(QQN::ShipmentCustomFieldHelper()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			$strQuery = sprintf('
				...
				FROM
					`shipment_custom_field_helper` AS `shipment_custom_field_helper`
				WHERE
					param_1 = %s AND
					param_2 < %s',
				$strParam1, $intParam2);
