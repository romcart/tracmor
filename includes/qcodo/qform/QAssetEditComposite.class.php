...
class QAssetEditComposite extends QControl {
  ...
  // Setup Save Button
	...
	public function btnPrintAssetTag_Click($strFormId, $strControlId, $strParameter) {
		$strImagePath = sprintf('../includes/php/barcode.php?code=%s&encoding=128&scale=%s&total_y=%s', $this->objAsset->AssetCode, QApplication::$TracmorSettings->AssetCodeScale, QApplication::$TracmorSettings->AssetCodeHeight);
