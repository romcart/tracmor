	...
	class CategoryDataGridGen extends QDataGrid {
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'CategoryId': return QQN::Category()->CategoryId;
				case 'ShortDescription': return QQN::Category()->ShortDescription;
				case 'LongDescription': return QQN::Category()->LongDescription;
				case 'ImagePath': return QQN::Category()->ImagePath;
				case 'AssetFlag': return QQN::Category()->AssetFlag;
				case 'InventoryFlag': return QQN::Category()->InventoryFlag;
				case 'CreatedBy': return QQN::Category()->CreatedBy;
				case 'CreatedByObject': return QQN::Category()->CreatedByObject;
				case 'CreationDate': return QQN::Category()->CreationDate;
				case 'ModifiedBy': return QQN::Category()->ModifiedBy;
				case 'ModifiedByObject': return QQN::Category()->ModifiedByObject;
				case 'ModifiedDate': return QQN::Category()->ModifiedDate;
				case 'CategoryCustomFieldHelper': return QQN::Category()->CategoryCustomFieldHelper;
