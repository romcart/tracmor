<?php
	 ...
	 * listing a collection of ShipmentCustomFieldHelper objects.  It includes
	 ...
	 * 
	 */
	class ShipmentCustomFieldHelperDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ShipmentCustomFieldHelper datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ShipmentCustomFieldHelper object, or it can be any QQNode extending from QQN::ShipmentCustomFieldHelper().
		 * 
		 ...
		 * sorting using two fields from the ShipmentCustomFieldHelper object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ShipmentCustomFieldHelper
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ShipmentCustomFieldHelper::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from ShipmentCustomFieldHelper, given the clauses above
			$this->DataSource = ShipmentCustomFieldHelper::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ShipmentCustomFieldHelper-based QQNode.
		 * It will also verify that it is a proper ShipmentCustomFieldHelper-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'shipment_custom_field_helper') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "shipment_custom_field_helper".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'ShipmentId': return QQN::ShipmentCustomFieldHelper()->ShipmentId;
				case 'Shipment': return QQN::ShipmentCustomFieldHelper()->Shipment;
				default: throw new QCallerException('Simple Property not found in ShipmentCustomFieldHelperDataGrid content: ' . $mixContent);
