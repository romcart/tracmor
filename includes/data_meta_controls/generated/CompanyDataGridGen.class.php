<?php
	...
	class CompanyDataGridGen extends QDataGrid {
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Company::CountAll();
			}
			...
			$this->DataSource = Company::LoadAll($objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'CompanyId': return QQN::Company()->CompanyId;
				case 'AddressId': return QQN::Company()->AddressId;
				case 'Address': return QQN::Company()->Address;
				case 'ShortDescription': return QQN::Company()->ShortDescription;
				case 'Website': return QQN::Company()->Website;
				case 'Telephone': return QQN::Company()->Telephone;
				case 'Fax': return QQN::Company()->Fax;
				case 'Email': return QQN::Company()->Email;
				case 'LongDescription': return QQN::Company()->LongDescription;
				case 'CreatedBy': return QQN::Company()->CreatedBy;
				case 'CreatedByObject': return QQN::Company()->CreatedByObject;
				case 'CreationDate': return QQN::Company()->CreationDate;
				case 'ModifiedBy': return QQN::Company()->ModifiedBy;
				case 'ModifiedByObject': return QQN::Company()->ModifiedByObject;
				case 'ModifiedDate': return QQN::Company()->ModifiedDate;
				case 'CompanyCustomFieldHelper': return QQN::Company()->CompanyCustomFieldHelper;
