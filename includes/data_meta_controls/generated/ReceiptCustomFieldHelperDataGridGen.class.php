<?php
	 ...
	 * listing a collection of ReceiptCustomFieldHelper objects.  It includes
	 ...
	 * 
	 */
	class ReceiptCustomFieldHelperDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ReceiptCustomFieldHelper datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ReceiptCustomFieldHelper object, or it can be any QQNode extending from QQN::ReceiptCustomFieldHelper().
		 * 
		 ...
		 * sorting using two fields from the ReceiptCustomFieldHelper object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ReceiptCustomFieldHelper
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ReceiptCustomFieldHelper::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ReceiptCustomFieldHelper-based QQNode.
		 * It will also verify that it is a proper ReceiptCustomFieldHelper-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'receipt_custom_field_helper') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "receipt_custom_field_helper".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'ReceiptId': return QQN::ReceiptCustomFieldHelper()->ReceiptId;
				case 'Receipt': return QQN::ReceiptCustomFieldHelper()->Receipt;
				default: throw new QCallerException('Simple Property not found in ReceiptCustomFieldHelperDataGrid content: ' . $mixContent);
