<?php
	 ...
	 * listing a collection of AssetModel objects.  It includes
	 ...
	 * 
	 */
	class AssetModelDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this AssetModel datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the AssetModel object, or it can be any QQNode extending from QQN::AssetModel().
		 * 
		 ...
		 * sorting using two fields from the AssetModel object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from AssetModel
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = AssetModel::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'AssetModelId': return QQN::AssetModel()->AssetModelId;
				case 'CategoryId': return QQN::AssetModel()->CategoryId;
				case 'Category': return QQN::AssetModel()->Category;
				case 'ManufacturerId': return QQN::AssetModel()->ManufacturerId;
				case 'Manufacturer': return QQN::AssetModel()->Manufacturer;
				case 'AssetModelCode': return QQN::AssetModel()->AssetModelCode;
				case 'ShortDescription': return QQN::AssetModel()->ShortDescription;
				case 'LongDescription': return QQN::AssetModel()->LongDescription;
				case 'ImagePath': return QQN::AssetModel()->ImagePath;
				case 'CreatedBy': return QQN::AssetModel()->CreatedBy;
				case 'CreatedByObject': return QQN::AssetModel()->CreatedByObject;
				case 'CreationDate': return QQN::AssetModel()->CreationDate;
