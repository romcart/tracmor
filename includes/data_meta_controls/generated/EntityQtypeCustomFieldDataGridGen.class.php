<?php
	 ...
	 * listing a collection of EntityQtypeCustomField objects.  It includes
	 ...
	 * 
	 */
	class EntityQtypeCustomFieldDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this EntityQtypeCustomField datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the EntityQtypeCustomField object, or it can be any QQNode extending from QQN::EntityQtypeCustomField().
		 * 
		 ...
		 * sorting using two fields from the EntityQtypeCustomField object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from EntityQtypeCustomField
		...
		public function MetaAddEditLinkColumn($strLinkUrl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit', $intArgumentType = QMetaControlArgumentType::PathInfo) {
			switch ($intArgumentType) {
				case QMetaControlArgumentType::QueryString:
					$strLinkUrl .= '?intEntityQtypeCustomFieldId=<?=urlencode($_ITEM->EntityQtypeCustomFieldId)?>';
					break;
				case QMetaControlArgumentType::PathInfo:
					$strLinkUrl .= '/<?=str_replace("+","%20",urlencode($_ITEM->EntityQtypeCustomFieldId))?>';
					break;
				default:
		...
		public function MetaAddEditProxyColumn(QControlProxy $pxyControl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit') {
			$strHtml = '<a href="#" <?= $_FORM->GetControl("' . $pxyControl->ControlId . '")->RenderAsEvents($_ITEM->EntityQtypeCustomFieldId, false); ?>>' . QApplication::Translate($strLinkHtml) . '</a>';
			$colEditColumn = new QDataGridColumn(QApplication::Translate($strColumnTitle), $strHtml, 'HtmlEntities=False');
			$this->AddColumn($colEditColumn);
			return $colEditColumn;
		}
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = EntityQtypeCustomField::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'EntityQtypeCustomFieldId': return QQN::EntityQtypeCustomField()->EntityQtypeCustomFieldId;
				case 'EntityQtypeId': return QQN::EntityQtypeCustomField()->EntityQtypeId;
				case 'CustomFieldId': return QQN::EntityQtypeCustomField()->CustomFieldId;
				case 'CustomField': return QQN::EntityQtypeCustomField()->CustomField;
				default: throw new QCallerException('Simple Property not found in EntityQtypeCustomFieldDataGrid content: ' . $mixContent);
