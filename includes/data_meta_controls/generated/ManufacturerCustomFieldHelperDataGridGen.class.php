<?php
	 ...
	 * listing a collection of ManufacturerCustomFieldHelper objects.  It includes
	...
	class ManufacturerCustomFieldHelperDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this ManufacturerCustomFieldHelper datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ManufacturerCustomFieldHelper object, or it can be any QQNode extending from QQN::ManufacturerCustomFieldHelper().
		 * 
		 ...
		 * sorting using two fields from the ManufacturerCustomFieldHelper object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ManufacturerCustomFieldHelper
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ManufacturerCustomFieldHelper-based QQNode.
		 * It will also verify that it is a proper ManufacturerCustomFieldHelper-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'manufacturer_custom_field_helper') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "manufacturer_custom_field_helper".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'ManufacturerId': return QQN::ManufacturerCustomFieldHelper()->ManufacturerId;
				case 'Manufacturer': return QQN::ManufacturerCustomFieldHelper()->Manufacturer;
				default: throw new QCallerException('Simple Property not found in ManufacturerCustomFieldHelperDataGrid content: ' . $mixContent);
