<?php
	 ...
	 * listing a collection of RoleEntityQtypeCustomFieldAuthorization objects.  It includes
	 ...
	 * 
	 */
	class RoleEntityQtypeCustomFieldAuthorizationDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this RoleEntityQtypeCustomFieldAuthorization datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the RoleEntityQtypeCustomFieldAuthorization object, or it can be any QQNode extending from QQN::RoleEntityQtypeCustomFieldAuthorization().
		 * 
		 ...
		 * sorting using two fields from the RoleEntityQtypeCustomFieldAuthorization object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from RoleEntityQtypeCustomFieldAuthorization
		...
		public function MetaAddEditLinkColumn($strLinkUrl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit', $intArgumentType = QMetaControlArgumentType::PathInfo) {
			switch ($intArgumentType) {
				case QMetaControlArgumentType::QueryString:
					$strLinkUrl .= '?intRoleEntityQtypeCustomFieldAuthorizationId=<?=urlencode($_ITEM->RoleEntityQtypeCustomFieldAuthorizationId)?>';
					break;
				case QMetaControlArgumentType::PathInfo:
					$strLinkUrl .= '/<?=str_replace("+","%20",urlencode($_ITEM->RoleEntityQtypeCustomFieldAuthorizationId))?>';
					break;
				default:
		...
		public function MetaAddEditProxyColumn(QControlProxy $pxyControl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit') {
			$strHtml = '<a href="#" <?= $_FORM->GetControl("' . $pxyControl->ControlId . '")->RenderAsEvents($_ITEM->RoleEntityQtypeCustomFieldAuthorizationId, false); ?>>' . $strLinkHtml . '</a>';
			$colEditColumn = new QDataGridColumn($strColumnTitle, $strHtml, 'HtmlEntities=False');
			$this->AddColumn($colEditColumn);
			return $colEditColumn;
		}
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = RoleEntityQtypeCustomFieldAuthorization::CountAll();
			}
			...
			$this->DataSource = RoleEntityQtypeCustomFieldAuthorization::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a RoleEntityQtypeCustomFieldAuthorization-based QQNode.
		 * It will also verify that it is a proper RoleEntityQtypeCustomFieldAuthorization-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'role_entity_qtype_custom_field_authorization') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "role_entity_qtype_custom_field_authorization".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'RoleEntityQtypeCustomFieldAuthorizationId': return QQN::RoleEntityQtypeCustomFieldAuthorization()->RoleEntityQtypeCustomFieldAuthorizationId;
				case 'RoleId': return QQN::RoleEntityQtypeCustomFieldAuthorization()->RoleId;
				case 'Role': return QQN::RoleEntityQtypeCustomFieldAuthorization()->Role;
				case 'EntityQtypeCustomFieldId': return QQN::RoleEntityQtypeCustomFieldAuthorization()->EntityQtypeCustomFieldId;
				case 'EntityQtypeCustomField': return QQN::RoleEntityQtypeCustomFieldAuthorization()->EntityQtypeCustomField;
				case 'AuthorizationId': return QQN::RoleEntityQtypeCustomFieldAuthorization()->AuthorizationId;
				case 'Authorization': return QQN::RoleEntityQtypeCustomFieldAuthorization()->Authorization;
				case 'AuthorizedFlag': return QQN::RoleEntityQtypeCustomFieldAuthorization()->AuthorizedFlag;
				case 'CreatedBy': return QQN::RoleEntityQtypeCustomFieldAuthorization()->CreatedBy;
				case 'CreatedByObject': return QQN::RoleEntityQtypeCustomFieldAuthorization()->CreatedByObject;
				case 'CreationDate': return QQN::RoleEntityQtypeCustomFieldAuthorization()->CreationDate;
				case 'ModifiedBy': return QQN::RoleEntityQtypeCustomFieldAuthorization()->ModifiedBy;
				case 'ModifiedByObject': return QQN::RoleEntityQtypeCustomFieldAuthorization()->ModifiedByObject;
				case 'ModifiedDate': return QQN::RoleEntityQtypeCustomFieldAuthorization()->ModifiedDate;
				default: throw new QCallerException('Simple Property not found in RoleEntityQtypeCustomFieldAuthorizationDataGrid content: ' . $mixContent);
