<?php
	 ...
	 * listing a collection of InventoryModel objects.  It includes
	 ...
	 * 
	 */
	class InventoryModelDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this InventoryModel datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the InventoryModel object, or it can be any QQNode extending from QQN::InventoryModel().
		 * 
		 ...
		 * sorting using two fields from the InventoryModel object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from InventoryModel
		...
		public function MetaAddEditLinkColumn($strLinkUrl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit', $intArgumentType = QMetaControlArgumentType::PathInfo) {
			switch ($intArgumentType) {
				case QMetaControlArgumentType::QueryString:
					$strLinkUrl .= '?intInventoryModelId=<?=urlencode($_ITEM->InventoryModelId)?>';
					break;
				case QMetaControlArgumentType::PathInfo:
					$strLinkUrl .= '/<?=str_replace("+","%20",urlencode($_ITEM->InventoryModelId))?>';
					break;
				default:
		...
		public function MetaAddEditProxyColumn(QControlProxy $pxyControl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit') {
			$strHtml = '<a href="#" <?= $_FORM->GetControl("' . $pxyControl->ControlId . '")->RenderAsEvents($_ITEM->InventoryModelId, false); ?>>' . QApplication::Translate($strLinkHtml) . '</a>';
			$colEditColumn = new QDataGridColumn(QApplication::Translate($strColumnTitle), $strHtml, 'HtmlEntities=False');
			$this->AddColumn($colEditColumn);
			return $colEditColumn;
		}
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = InventoryModel::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'InventoryModelId': return QQN::InventoryModel()->InventoryModelId;
				case 'CategoryId': return QQN::InventoryModel()->CategoryId;
				case 'Category': return QQN::InventoryModel()->Category;
				case 'ManufacturerId': return QQN::InventoryModel()->ManufacturerId;
				case 'Manufacturer': return QQN::InventoryModel()->Manufacturer;
				case 'InventoryModelCode': return QQN::InventoryModel()->InventoryModelCode;
				case 'ShortDescription': return QQN::InventoryModel()->ShortDescription;
				case 'LongDescription': return QQN::InventoryModel()->LongDescription;
				case 'ImagePath': return QQN::InventoryModel()->ImagePath;
				case 'Price': return QQN::InventoryModel()->Price;
				case 'CreatedBy': return QQN::InventoryModel()->CreatedBy;
				case 'CreatedByObject': return QQN::InventoryModel()->CreatedByObject;
				case 'CreationDate': return QQN::InventoryModel()->CreationDate;
				case 'ModifiedBy': return QQN::InventoryModel()->ModifiedBy;
				case 'ModifiedByObject': return QQN::InventoryModel()->ModifiedByObject;
				case 'ModifiedDate': return QQN::InventoryModel()->ModifiedDate;
				case 'InventoryModelCustomFieldHelper': return QQN::InventoryModel()->InventoryModelCustomFieldHelper;

				default: throw new QCallerException('Simple Property not found in InventoryModelDataGrid content: ' . $mixContent);
