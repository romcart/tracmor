<?php
	 ...
	 * listing a collection of ContactCustomFieldHelper objects.  It includes
	 ...
	 * 
	 */
	class ContactCustomFieldHelperDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ContactCustomFieldHelper datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ContactCustomFieldHelper object, or it can be any QQNode extending from QQN::ContactCustomFieldHelper().
		 * 
		 ...
		 * sorting using two fields from the ContactCustomFieldHelper object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ContactCustomFieldHelper
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ContactCustomFieldHelper::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ContactCustomFieldHelper-based QQNode.
		 * It will also verify that it is a proper ContactCustomFieldHelper-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'contact_custom_field_helper') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "contact_custom_field_helper".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'ContactId': return QQN::ContactCustomFieldHelper()->ContactId;
				case 'Contact': return QQN::ContactCustomFieldHelper()->Contact;
				default: throw new QCallerException('Simple Property not found in ContactCustomFieldHelperDataGrid content: ' . $mixContent);
