<?php
	 ...
	 * listing a collection of Asset objects.  It includes
	 ...
	 * 
	 */
	class AssetDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Asset datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Asset object, or it can be any QQNode extending from QQN::Asset().
		 * 
		 ...
		 * sorting using two fields from the Asset object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Asset
		...
		public function MetaAddEditLinkColumn($strLinkUrl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit', $intArgumentType = QMetaControlArgumentType::PathInfo) {
			switch ($intArgumentType) {
				case QMetaControlArgumentType::QueryString:
					$strLinkUrl .= '?intAssetId=<?=urlencode($_ITEM->AssetId)?>';
					break;
				case QMetaControlArgumentType::PathInfo:
					$strLinkUrl .= '/<?=str_replace("+","%20",urlencode($_ITEM->AssetId))?>';
					break;
				default:
		...
		public function MetaAddEditProxyColumn(QControlProxy $pxyControl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit') {
			$strHtml = '<a href="#" <?= $_FORM->GetControl("' . $pxyControl->ControlId . '")->RenderAsEvents($_ITEM->AssetId, false); ?>>' . QApplication::Translate($strLinkHtml) . '</a>';
			$colEditColumn = new QDataGridColumn(QApplication::Translate($strColumnTitle), $strHtml, 'HtmlEntities=False');
			$this->AddColumn($colEditColumn);
			return $colEditColumn;
		}
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Asset::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Asset, given the clauses above
			$this->DataSource = Asset::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'AssetId': return QQN::Asset()->AssetId;
				case 'ParentAssetId': return QQN::Asset()->ParentAssetId;
				case 'ParentAsset': return QQN::Asset()->ParentAsset;
				case 'AssetModelId': return QQN::Asset()->AssetModelId;
				case 'AssetModel': return QQN::Asset()->AssetModel;
				case 'LocationId': return QQN::Asset()->LocationId;
				case 'Location': return QQN::Asset()->Location;
				case 'AssetCode': return QQN::Asset()->AssetCode;
				case 'ImagePath': return QQN::Asset()->ImagePath;
				case 'CheckedOutFlag': return QQN::Asset()->CheckedOutFlag;
				case 'ReservedFlag': return QQN::Asset()->ReservedFlag;
				case 'LinkedFlag': return QQN::Asset()->LinkedFlag;
				case 'ArchivedFlag': return QQN::Asset()->ArchivedFlag;
				case 'CreatedBy': return QQN::Asset()->CreatedBy;
				case 'CreatedByObject': return QQN::Asset()->CreatedByObject;
				case 'CreationDate': return QQN::Asset()->CreationDate;
				...
				case 'DepreciationClassId': return QQN::Asset()->DepreciationClassId;
				case 'DepreciationClass': return QQN::Asset()->DepreciationClass;
