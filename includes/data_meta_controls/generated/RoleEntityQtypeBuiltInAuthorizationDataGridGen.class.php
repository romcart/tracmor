<?php
	 ...
	 * listing a collection of RoleEntityQtypeBuiltInAuthorization objects.  It includes
	 ...
	 * 
	 */
	class RoleEntityQtypeBuiltInAuthorizationDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this RoleEntityQtypeBuiltInAuthorization datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the RoleEntityQtypeBuiltInAuthorization object, or it can be any QQNode extending from QQN::RoleEntityQtypeBuiltInAuthorization().
		 * 
		 ...
		 * sorting using two fields from the RoleEntityQtypeBuiltInAuthorization object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from RoleEntityQtypeBuiltInAuthorization
		...
		public function MetaAddEditLinkColumn($strLinkUrl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit', $intArgumentType = QMetaControlArgumentType::PathInfo) {
			switch ($intArgumentType) {
				case QMetaControlArgumentType::QueryString:
					$strLinkUrl .= '?intRoleEntityBuiltInId=<?=urlencode($_ITEM->RoleEntityBuiltInId)?>';
					break;
				case QMetaControlArgumentType::PathInfo:
					$strLinkUrl .= '/<?=str_replace("+","%20",urlencode($_ITEM->RoleEntityBuiltInId))?>';
					break;
				default:
		...
		public function MetaAddEditProxyColumn(QControlProxy $pxyControl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit') {
			$strHtml = '<a href="#" <?= $_FORM->GetControl("' . $pxyControl->ControlId . '")->RenderAsEvents($_ITEM->RoleEntityBuiltInId, false); ?>>' . $strLinkHtml . '</a>';
			$colEditColumn = new QDataGridColumn($strColumnTitle, $strHtml, 'HtmlEntities=False');
			$this->AddColumn($colEditColumn);
			return $colEditColumn;
		}
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = RoleEntityQtypeBuiltInAuthorization::CountAll();
			}
			...
			$this->DataSource = RoleEntityQtypeBuiltInAuthorization::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a RoleEntityQtypeBuiltInAuthorization-based QQNode.
		 * It will also verify that it is a proper RoleEntityQtypeBuiltInAuthorization-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'role_entity_qtype_built_in_authorization') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "role_entity_qtype_built_in_authorization".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'RoleEntityBuiltInId': return QQN::RoleEntityQtypeBuiltInAuthorization()->RoleEntityBuiltInId;
				case 'RoleId': return QQN::RoleEntityQtypeBuiltInAuthorization()->RoleId;
				case 'Role': return QQN::RoleEntityQtypeBuiltInAuthorization()->Role;
				case 'EntityQtypeId': return QQN::RoleEntityQtypeBuiltInAuthorization()->EntityQtypeId;
				case 'AuthorizationId': return QQN::RoleEntityQtypeBuiltInAuthorization()->AuthorizationId;
				case 'Authorization': return QQN::RoleEntityQtypeBuiltInAuthorization()->Authorization;
				case 'AuthorizedFlag': return QQN::RoleEntityQtypeBuiltInAuthorization()->AuthorizedFlag;
				case 'CreatedBy': return QQN::RoleEntityQtypeBuiltInAuthorization()->CreatedBy;
				case 'CreatedByObject': return QQN::RoleEntityQtypeBuiltInAuthorization()->CreatedByObject;
				case 'CreationDate': return QQN::RoleEntityQtypeBuiltInAuthorization()->CreationDate;
				case 'ModifiedBy': return QQN::RoleEntityQtypeBuiltInAuthorization()->ModifiedBy;
				case 'ModifiedByObject': return QQN::RoleEntityQtypeBuiltInAuthorization()->ModifiedByObject;
				case 'ModifiedDate': return QQN::RoleEntityQtypeBuiltInAuthorization()->ModifiedDate;
				default: throw new QCallerException('Simple Property not found in RoleEntityQtypeBuiltInAuthorizationDataGrid content: ' . $mixContent);
