<?php
	...
	class InventoryModelCustomFieldHelperDataGridGen extends QDataGrid {
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = InventoryModelCustomFieldHelper::QueryCount($objCondition, $objClauses);
			...
			$this->DataSource = InventoryModelCustomFieldHelper::QueryArray($objCondition, $objClauses);
		}
