<?php
	require(__DATAGEN_META_CONTROLS__ . '/RoleDataGridGen.class.php');

	/**
	 * This is the "Meta" DataGrid customizable subclass for the List functionality
	 * of the Role class.  This code-generated class extends
	 * from the generated Meta DataGrid class which contains a QDataGrid class which
	 * can be used by any QForm or QPanel, listing a collection of Role
	 ...
	 * 
	 */
	class RoleDataGrid extends RoleDataGridGen {
	}
?>