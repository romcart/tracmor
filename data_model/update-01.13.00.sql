...
ALTER TABLE `shipping_account` DROP FOREIGN KEY `shipping_account_ibfk_3` , DROP FOREIGN KEY `shipping_account_ibfk_2` , DROP FOREIGN KEY `shipping_account_ibfk_1` ;
